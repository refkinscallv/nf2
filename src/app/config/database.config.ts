...
import { DatabaseConfigCommon, DatabaseConfigMongoDB, DatabaseConfigMySQL, DatabaseConfigOracle, DatabaseConfigPostgreSQL, DatabaseConfigSQLite } from '@type/core'

export default class DatabaseConfig {
    public static common: DatabaseConfigCommon = {
    ...
    public static mysql: DatabaseConfigMySQL = {
    ...
    public static postgres: DatabaseConfigPostgreSQL = {
        host: CoreCommon.env<string>('DB_HOST', 'localhost'),
    ...
    public static sqlite: DatabaseConfigSQLite = {
        database: CoreCommon.env<string>('DB_PATH', 'database.sqlite'),
    }

    public static mongodb: DatabaseConfigMongoDB = {
        url: CoreCommon.env<string>('DB_URL', 'mongodb://localhost:27017'),
        useUnifiedTopology: true,
    }

    public static oracle: DatabaseConfigOracle = {
        host: CoreCommon.env<string>('DB_HOST', 'localhost'),
